...
"[project]/app/super-login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SuperLogin() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const { data: saUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('super_admin_users').select('*').eq('access_key', cleanKey).single();
            if (saUser) {
            ...
            const { data: dbKeys } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('access_keys').select('*').ilike('key_code', cleanKey);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eed4f251._.js.map